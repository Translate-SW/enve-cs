...
void OutputSettingsProfile::load(const QString &path) {
    ...
    } else RuntimeThrow("Nepodařilo se načíst obsah souboru .\n" +
                        "Selhalo otevření souboru: '" + path + "'.");
    emit changed();
}
